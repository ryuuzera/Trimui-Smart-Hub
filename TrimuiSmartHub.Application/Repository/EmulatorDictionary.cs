...
namespace TrimuiSmartHub.Application.Repository
{
    internal static class EmulatorDictionary
    {
        ...
        public static Dictionary<string, string> EmulatorMapMegathread = new()
        {
            { "ARCADE", "MAME" },
            { "ATARI2600", "Atari - 2600" },
            { "ATARI7800", "Atari - 7800" },
            { "CPS1", "https://archive.org/download/fbnarcade-fullnonmerged/arcade/" },
            { "CPS2", "https://archive.org/download/fbnarcade-fullnonmerged/arcade/" },
            { "CPS3", "https://archive.org/download/fbnarcade-fullnonmerged/arcade/" },
            { "DC", "Sega - Dreamcast" },
